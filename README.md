...
```javascript
ns = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/number-int32-base@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/number-int32-base@umd/bundle.js"></script>
```
